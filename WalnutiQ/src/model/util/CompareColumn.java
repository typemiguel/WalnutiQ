...
// -------------------------------------------------------------------------
/**
 *  This class overrides the compare method of abstract class Comparator
 *  to compare two Column objects based on their overlapScores. Create a
 *  comparator object like the following in the class that needs an array sorted:
 *
 *  Comparator<Column> comparator = new CompareColumn();
 *
 *  Then call Array.sort(arrayOfColumnObjectsToBeSorted, comparator);
 *  arrayOfColumnObjectsToBeSorted is now sorted.
 *
 *  @author Huanqing
 *  @version Jan 9, 2013
 */
    ...
    implements Comparator<Column>
{
     ...
     *
     * @param leftColumn The left-hand side of the comparison.
     * @param rightColumn The right-hand side of the comparison.
