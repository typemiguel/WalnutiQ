 ...
 */
public class MARKII_Region implements Serializable {
    private String biologicalName;
    private List<MARKII_Region> children;

    private final MARKII_Column[][] columns;
    ...
    public MARKII_Region(String biologicalName, int numberOfColumnsAlongXAxis,
	...
	if (getClass() != obj.getClass())
	    return false;
	MARKII_Region other = (MARKII_Region) obj;
